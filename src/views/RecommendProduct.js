        ...
        >
            <Grid xs={12}  md={10} lg={8}>
                <Breadcrumbs aria-label="breadcrumb" style={{marginTop:40}}>
                    ...
                    <Typography color="textPrimary" style={{fontWeight:"bold",fontSize:"1.4rem"}}>สินค้าแนะนำ</Typography>
                </Breadcrumbs>
                <Grid
                    container
                    direction="row"
                ...
                >
                        <Typography  color="inherit" style={{fontSize:"1rem",marginTop:-10,color:"BLACK"}}>
                            จำนวนสินค้า {props.bookProv.book_list_recommend.length} รายการ
                        </Typography>
                </Grid>
                <Grid
                    container
                ...
                >
                    {
                        props.bookProv.book_list_recommend.map((item,index) => {
                            return (
...
export default inject("bookProv")(observer(RecommendProduct)); 
