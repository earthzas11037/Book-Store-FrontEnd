...
function EditBook(props) {
    ...
    const getData = async() => { 
        ...
        const target = pathArray[3];
        await props.bookProv.getBookDetailEdit(target,props.authenProv.user_id)
    }
                ...
                >
                    ...
                    <Grid item xs={12} md={8}>
                        ...
                        >
                            ...
                            <Grid item xs={12} md={3}>
                                <Button variant="contained" color="primary" disableElevation style={{width:"100%",marginTop:20,marginLeft:20,paddingTop:10,paddingBottom:10,fontSize:"1.2rem"}} onClick={e => handleEdit()}>
                                    ยืนยัน
                                </Button>
                            </Grid>
                        </Grid>
...
export default inject("authenProv","bookProv")(observer(EditBook)); 
